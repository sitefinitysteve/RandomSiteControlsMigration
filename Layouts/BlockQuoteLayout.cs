...
namespace RandomSiteControls.Layouts {
    public class BlockQuoteLayout : SteveLayoutControlBase {
        ...
        public string CustomTempalate = "~/SitefinitySteve/RandomSiteControls.Layouts.Views.BlockQuoteLayout.ascx";
        #endregion
    }
}
